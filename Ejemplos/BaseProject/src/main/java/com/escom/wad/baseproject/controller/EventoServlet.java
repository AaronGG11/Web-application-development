...
public class EventoServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            evento.setNombreEvento(request.getParameter("txtnombre"));
            evento.setSede(request.getParameter("txtsede"));
            evento.setFechaInicio(Date.valueOf("2020-10-19"));
            evento.setFechaFin(Date.valueOf("2020-10-23"));
